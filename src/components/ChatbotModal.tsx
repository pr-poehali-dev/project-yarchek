      ...
      >
        ...
        <div className="h-[80vh] w-full overflow-hidden rounded-lg flex items-center justify-center bg-gray-900">
          <div className="text-center text-white p-8">
            <p className="text-xl mb-4">ИИ-ассистент по курсам</p>
            <p className="text-gray-400">Спроси меня о любом курсе — расскажу программу, стоимость и с чего начать.</p>
            <p className="text-gray-500 mt-4 text-sm">Или напишите нам напрямую через форму ниже.</p>
          </div>
        </div>
      </div>
    </div>
